...
cd /tmp/aqua-dev/
git checkout  <branch>
rsync -rlp --exclude '.git' --exclude './android/android_keys' --exclude './crypto' --exclude './operational-tools' --exclude './boltz-rust' --exclude './public_repo_instructions.md' * /tmp/aqua-dev-public/
