...
install:
	/Users/mac/Downloads/flutter2/bin/flutter pub get
...
generate-bindings:
	/Users/mac/Downloads/flutter2/bin/flutter pub run ffigen --config ffigen.yaml
...
run-unit-tests:
	/Users/mac/Downloads/flutter2/bin/flutter test

run-integration-tests:
	/Users/mac/Downloads/flutter2/bin/flutter test integration_test
