...
class SettingsScreenKeys {
  static const settingsScrollableScreenMenu = Key("scrollable-screen-menu");
  static const settingsGetHelpSupportButton = Key("get-help-support-button");
  ...
  static const settingsDirectPegInButton = Key("direct-peg-in-button");

  static const settingsRemoveWalletButton = Key("remove-wallet-button");
}
