...
class BasicTransactionSideSheet extends HookWidget {
  BasicTransactionSideSheet.send({
  ...
  BasicTransactionSideSheet.receive({
    required this.iconAssetId,
    required this.timestamp,
    required this.amountCrypto,
    required this.amountFiat,
  ...
  BasicTransactionSideSheet.swap({
    ...
    return Padding(
      ...
      child: Column(
        children: [
                      ...
                      children: [
                        ...
                        if (_type.isSwap) ...[
                          ...
                          AquaListItem(
                            title: loc.provider,
                            backgroundColor: aquaColors.surfacePrimary,
                            subtitleTrailing: 'SideSwap',
                            subtitleTrailingColor: aquaColors.accentBrand,
                            iconTrailing: AquaIcon.externalLink(
                              color: aquaColors.textSecondary,
                            ),
                            onTap: () =>
                                debugPrint('Open external link or page'),
                          ),
                        ],
                        if (_type.isSend || _type.isSwap) ...[
                          const StylizedDivider(),
                          AquaListItem(
                            title: _type.isSend
                        ...
                        if (!_type.isSwap) ...[
                          ...
                          if (iconAssetId == AssetIds.btc) ...[
                            AquaListItem(
                              ...
                              onTap: () => context.showAquaSnackbar(
                                  message: 'Open external link or page'),
                            ),
                          ] else ...[
                            AquaListItem(
                              title: loc.viewInExplorer,
          ...
          if (!_type.isReceive && isPending) ...[
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: AquaButton.primary(
                text: loc.increaseFee,
                onPressed: () {
                  debugPrint('Increase fee tapped');
                },
              ),
            )
          ],
