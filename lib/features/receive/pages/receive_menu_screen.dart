...
class ReceiveMenuScreen extends HookConsumerWidget {
  const ReceiveMenuScreen({super.key});

  static const routeName = '/receiveMenu';

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final assets = ref.watch(receiveAssetsListProvider);
    ...
    return DesignRevampScaffold(
      ...
      body: Container(
        ...
        child: AquaAssetSelector.receive(
          assets: assets.withSelectorSubtitles(
