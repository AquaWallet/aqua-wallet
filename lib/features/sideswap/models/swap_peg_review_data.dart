...
class SwapPegReviewModel {
  SwapPegReviewModel({
    ...
    required this.firstOnchainFeeAmount,
    required this.secondOnchainFeeAmount,
  ...
  final int firstOnchainFeeAmount;
  final int secondOnchainFeeAmount;
  ...
  int get feeAmount => firstOnchainFeeAmount + secondOnchainFeeAmount;
}
